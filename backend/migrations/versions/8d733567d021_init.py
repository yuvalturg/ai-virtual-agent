...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'devops', 'user', name='role'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['virtual_assistant_id'], ['virtual_assistants.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('virtual_assistant_knowledge_bases',
    sa.Column('virtual_assistant_id', sa.UUID(), nullable=False),
    sa.Column('vector_db_name', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['vector_db_name'], ['knowledge_bases.vector_db_name'], ),
    sa.ForeignKeyConstraint(['virtual_assistant_id'], ['virtual_assistants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('virtual_assistant_id', 'vector_db_name')
    )
    op.create_table('virtual_assistant_tools',
    sa.Column('virtual_assistant_id', sa.UUID(), nullable=False),
    sa.Column('tool_type', sa.Enum('BUILTIN', 'MCP_SERVER', name='tool_type_enum', create_constraint=True), nullable=False),
    sa.Column('toolgroup_id', sa.String(length=255), nullable=False),
    sa.ForeignKeyConstraint(['virtual_assistant_id'], ['virtual_assistants.id'], ondelete='CASCADE'),
